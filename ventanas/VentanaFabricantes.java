...
public class VentanaFabricantes extends JFrame implements ActionListener {
	 ...
	 * esto usamos logica de programaci�n por medio de la captura de informaci�n
	...
	public void mostrarDatosUsandoLogica1() {
		...
		String informacion[][] = obtieneMatriz2();// obtenemos la informacion de
		// la BD
	...
	/**
	 * Metodo que permite retornar la matriz con informaci�n de la BD
	 * 
	 * @return
	 */
